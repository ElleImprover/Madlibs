    ...
    class Program
    {
        ...
        public static void AskQuestions()
        {
            ...
            do
            {
                ...
                Console.WriteLine(ParseAndCreateMadLibString(madlib.qaList));
            ...
            {
                {
                    ...
                    {
                        nQA = qAs.Find(x => x.OrderID ==(int) Char.GetNumericValue(c));
                        string2Parse = string2Parse.Replace(c.ToString(), nQA.Answer);
